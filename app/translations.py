...
UI_TEXT = {
    "EN": {
        ...
        "upload_sub": "Limit 200MB per file • JPG, JPEG, PNG supported",
    ...
    "BN": {
        ...
        "upload_sub": "অথবা বক্সের ভেতর <strong>Browse files</strong> বাটনে ক্লিক করে ডিভাইস থেকে ছবি বেছে নিন • JPG, JPEG, PNG সমর্থিত",
